...
export const labOrders = [
  ...
  { id: 'lab1', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'Complete Blood Count', status: 'order placed', timestamp: '2025-05-11 08:30', taskType: 'lab' },
  { id: 'lab2', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'Troponin I', status: 'needs to be collected', timestamp: '2025-05-11 07:15', taskType: 'lab' },
  { id: 'lab3', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'Basic Metabolic Panel', status: 'acknowledged by nurse', timestamp: '2025-05-11 06:45', taskType: 'lab' },
  
  // Resulted orders - older timestamps since they're completed
  { id: 'lab4', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'D-Dimer', status: 'resulted', timestamp: '2025-05-09 14:30', 
    result: 'D-Dimer: 0.4 mg/L FEU (Reference Range: <0.5 mg/L FEU)', abnormal: false, taskType: 'lab' },
  { id: 'lab5', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'Cardiac Enzymes', status: 'resulted', timestamp: '2025-05-08 15:45', 
  ...
  { id: 'lab6', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'Electrolytes', status: 'resulted', timestamp: '2025-05-07 13:20', 
  ...
  { id: 'lab7', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Comprehensive Metabolic Panel', status: 'collected', timestamp: '2025-05-11 02:15', taskType: 'lab' },
  { id: 'lab8', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Lipase', status: 'in process', timestamp: '2025-05-10 23:00', taskType: 'lab' },
  { id: 'lab9', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Amylase', status: 'order placed', timestamp: '2025-05-10 22:30', taskType: 'lab' },
  
  // Resulted orders - Emily
  { id: 'lab10', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Complete Blood Count', status: 'resulted', timestamp: '2025-05-05 16:45', 
  ...
  { id: 'lab11', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Liver Function Tests', status: 'resulted', timestamp: '2025-05-04 17:30', 
  ...
  { id: 'lab12', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Urinalysis', status: 'resulted', timestamp: '2025-05-04 15:15', 
    result: 'Color: Yellow\nClarity: Clear\npH: 6.0\nSpecific Gravity: 1.015\nGlucose: Negative\nBilirubin: Negative\nKetones: Negative\nBlood: Trace\nProtein: Negative\nNitrite: Negative\nLeukocyte Esterase: Trace\nWBC: 2-5/HPF\nRBC: 1-3/HPF', abnormal: true, taskType: 'lab' },
  { id: 'lab13', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Lipid Panel', status: 'resulted', timestamp: '2025-04-30 12:45', 
  ...
  { id: 'lab14', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Hemoglobin A1c', status: 'resulted', timestamp: '2025-04-25 14:20', 
    result: 'HbA1c: 5.8% (Reference Range: <5.7%)', abnormal: true, taskType: 'lab' },
  
  // David Williams (Patient 3) - more recent urgent orders
  { id: 'lab15', patient: 'David Williams', mrn: 'MRN10003', type: 'Arterial Blood Gas', status: 'collected', timestamp: '2025-05-11 06:30', taskType: 'lab', urgent: true },
  { id: 'lab16', patient: 'David Williams', mrn: 'MRN10003', type: 'Blood Culture x2', status: 'in process', timestamp: '2025-05-11 05:00', taskType: 'lab', urgent: true },
  { id: 'lab17', patient: 'David Williams', mrn: 'MRN10003', type: 'Respiratory Viral Panel', status: 'needs to be collected', timestamp: '2025-05-11 04:15', taskType: 'lab' },
  
  // Resulted orders - David (more recent since they're critical)
  { id: 'lab18', patient: 'David Williams', mrn: 'MRN10003', type: 'Arterial Blood Gas', status: 'resulted', timestamp: '2025-05-11 00:15', 
  ...
  { id: 'lab19', patient: 'David Williams', mrn: 'MRN10003', type: 'Complete Blood Count', status: 'resulted', timestamp: '2025-05-10 22:30', 
  ...
  { id: 'lab20', patient: 'David Williams', mrn: 'MRN10003', type: 'C-Reactive Protein', status: 'resulted', timestamp: '2025-05-10 20:45', 
    result: 'CRP: 15.5 mg/L (Reference Range: <3.0 mg/L)', abnormal: true, taskType: 'lab' },
  { id: 'lab21', patient: 'David Williams', mrn: 'MRN10003', type: 'Procalcitonin', status: 'resulted', timestamp: '2025-05-10 19:20', 
    result: 'Procalcitonin: 0.8 ng/mL (Reference Range: <0.5 ng/mL)', abnormal: true, taskType: 'lab' },
  { id: 'lab22', patient: 'David Williams', mrn: 'MRN10003', type: 'NT-proBNP', status: 'resulted', timestamp: '2025-05-10 18:10', 
...
export const medicationOrders = [
  { id: 'med1', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'Acetaminophen 650mg PO Q6H PRN pain', status: 'ordered', timestamp: '2025-05-11 08:15', taskType: 'medication' },
  { id: 'med2', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'Aspirin 325mg PO once', status: 'administered', timestamp: '2025-05-11 07:20', taskType: 'medication' },
  { id: 'med3', patient: 'Michael Johnson', mrn: 'MRN10001', type: 'Metoprolol 25mg PO BID', status: 'ordered', timestamp: '2025-05-11 06:30', taskType: 'medication' },
  { id: 'med4', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Ondansetron 4mg IV Q6H PRN nausea', status: 'ordered', timestamp: '2025-05-11 05:45', taskType: 'medication' },
  { id: 'med5', patient: 'Emily Rodriguez', mrn: 'MRN10002', type: 'Ketorolac 15mg IV Q6H PRN pain', status: 'administered', timestamp: '2025-05-11 02:30', taskType: 'medication' },
  ...
  { id: 'med9', patient: 'Sophia Lee', mrn: 'MRN10004', type: 'Lidocaine 2% for infiltration', status: 'ordered', timestamp: '2025-05-11 09:10', taskType: 'medication' },
  { id: 'med10', patient: 'Robert Johnson', mrn: 'MRN10005', type: 'Ceftriaxone 1g IV daily', status: 'ordered', timestamp: '2025-05-11 04:20', taskType: 'medication' },
  { id: 'med11', patient: 'Lisa Martinez', mrn: 'MRN10006', type: 'Sumatriptan 6mg SC once', status: 'ordered', timestamp: '2025-05-11 03:40', taskType: 'medication' },
];
